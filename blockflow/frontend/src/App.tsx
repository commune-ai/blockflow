...
useEffect(() => {
	...
	return (
		...
		<div className="h-full flex flex-col">
			...
			<a target={"_blank"} href="https://commune.ai/" className="absolute bottom-1 left-1 text-gray-500 text-xs cursor-pointer font-sans tracking-wide">Created by commune</a>
		</div>
	);
}
